...
class MemeEditorViewController: UIViewController {
	...
	func saveModel(memedImage: UIImage) {
		let memeModel = Meme(entity: coreDataStack.memeEntity, insertIntoManagedObjectContext: coreDataStack.managedObjectContext)
		
		memeModel.topText = topTextField.text ?? ""
		memeModel.bottomText = bottomTextField.text ?? ""
		memeModel.originalImage = imageView.image!
		memeModel.memedImage = memedImage
		memeModel.memedImageIcon = UIImage.resizeImage(memedImage, newSize: imageIconSize)
